...
static int wan_setUpIPv4(WanMgr_IfaceSM_Controller_t * pWanIfaceCtrl)
{
    ...
    snprintf(syseventParam, sizeof(syseventParam), "ipv4_%s_start_time", p_VirtIf->Name);
    sysevent_set(sysevent_fd, sysevent_token, syseventParam, buf, 0);

#if defined(FEATURE_RDKB_CONFIGURABLE_WAN_INTERFACE)
    snprintf(syseventParam, sizeof(syseventParam), "ipv4_%s_dhcp_server", p_VirtIf->Name);
    snprintf(buf, sizeof(buf), "%s", p_VirtIf->IP.Ipv4Data.dhcpServerId);
    sysevent_set(sysevent_fd, sysevent_token, syseventParam, buf, 0);

    snprintf(syseventParam, sizeof(syseventParam), "ipv4_%s_lease_time", p_VirtIf->Name);
    snprintf(buf, sizeof(buf), "%s", p_VirtIf->IP.Ipv4Data.leaseTime);
    sysevent_set(sysevent_fd, sysevent_token, syseventParam, buf, 0);
    
    snprintf(syseventParam, sizeof(syseventParam), "ipv4_%s_dhcp_state", p_VirtIf->Name);
    snprintf(buf, sizeof(buf), "%s", p_VirtIf->IP.Ipv4Data.dhcpState);
    sysevent_set(sysevent_fd, sysevent_token, syseventParam, buf, 0);
#endif
